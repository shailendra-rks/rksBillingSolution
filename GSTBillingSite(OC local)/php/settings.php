...
if(!isset($_SESSION['isUsrLoggedIn']) || $_SESSION['isUsrLoggedIn'] == "false"){
	log_msg("Unauthrised Access.|22|8|3");
...
elseif($_SESSION['isUsrLoggedIn'] == "true") {
	...
	if($usrPerm['billV'] == 1){
		...
		log_msg("DOM Manipulation Detected.|22|32|5");
		send_dashboard("Access Denied !!");
	}
}
else{
	log_msg("Unauthrised Access.|22|37|3");
	send_home("Please, Log In !!");
}
?>
...
<?php endif; ?>
	...
	<form id="settingsForm" action="updateSettings.php" method="post" class="fullpage">
