...
<?php if($mode == "add" && $usrPerm['billC'] == 1): ?>
		...
		<div class="billleft">
			<div class="inline-flex">
				<div class="pagecell">
					...
					<div><input type="date" name="billDate" max="<?php echo $maxDate; ?>" required></div>
				</div>
	...
	<?php endif; ?>
				<div class="pagecell">
					...
					<input type="text" name="unq1" required>
				</div>
			</div>
	<?php if($usrPerm['vhclV'] == 1): ?>
			<div class="inline-flex">
		...
		<div class="billItems" id="billItems">
			...
			<?php if($usrInfo['biltyCust'] == 0): ?>
					<tr>			<!--repeater row-->
						...
						<td>
							<div class="pTabCell">
								<input type="number" id="rate" value="" step="any" onchange="calcRowAmtRate(this.value)" required>						
							</div>
						</td>
						<td>
							<div class="pTabCell">
			...
			<?php if($usrInfo['biltyCust'] == 1): ?>
					<tr>			<!--stand alone row-->
						...
						<td>
						<div class="pTabCell">
							<input type="number" id="rate" name="rate" value="" step="any" onchange="calcAmtRate(this.value)" required>						
						</div>
						</td>
						<td>
						<div class="pTabCell">
	...
	<div class="billtop">
		<div class="billleft">
			<div class="inline-flex">
				<div class="pagecell">
					<label for="billDate"><b>Date</b></label>
					<div><input type="date" name="billDate" value="<?php echo $billDetails['billdate']; ?>" readonly></div>
				</div>
				<div class="modaldiv"></div>
				<div class="pagecell">
					<label for="purOrdNum"><b>Purchase Order No.</b></label>
			...
			<div class="inline-flex">
				...
				<div class="pagecell">
					<label for="unq1"><b><?php echo $usrInfo['unqFld1']; ?></b></label>
					<input type="text" value="<?php echo $billDetails['unqFld1']; ?>" name="unq1" required>
				</div>
			</div>
			<div class="inline-flex">
				<div class="pagecell">					
		...
		<div class="billItems" id="billItems">
			...
			<?php if($usrInfo['biltyCust'] == 1): ?>
					<tr>			<!--stand alone row-->
						...
						<td>
						<div class="pTabCell">
							<input type="number" id="rate" name="rate" value="<?php echo $billItemList['rate']; ?>" step="any" onchange="calcAmtRate(this.value)" required>
						</div>
						</td>
						<td>
						<div class="pTabCell">
