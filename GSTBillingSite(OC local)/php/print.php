...
<?php endif; ?>
	...
	<script type="text/javascript" src="/clientJs/print.js"></script>																	<!--address tag-->	
</head>
<body>
		...
		<div class="bill_head">
			<div class="print_row">
				<div class="print_logo">
					<img src="/img/<?php echo $billDetails['logo']; ?>" alt="profileImg">															<!--address tag-->
					<div class="txt_bold">
			...
			<hr class="on_txt">
			<div class="float_centre"><b>TAX INVOICE (Original Copy)</b></div>
			<hr>
			<div class="print_row">
				<div style="width:32%;">
				...
				<div class="middle" style="width:32%;">
		...
		<div class="bill_content">	
			<div class="bill_items">
				<table id="bill_table" style="width:100%">
					...
					<?php $i=1; foreach($ItemList as $Item): ?>
						...
						<?php elseif($siteSettings['printMode'] == 2): ?>
							<td><?php echo (1*$Item['qty'])."x".(1*$Item['rate']); ?></td>
						<?php endif; ?>
			...
			<table style="width:100%">
				<tfoot>
					...
					<?php elseif($siteSettings['printMode'] == 2): ?>
						<td colspan="2"><?php echo (1*$billResult['fQty'])."x".(1*$billResult['fRate']); ?></td>					
					<?php endif; ?>
			...
			<hr>
			<div class="print_row">
				<div class="print_row" style="width:60%;">
					<div class="first print_row">
						<div class="fixed_width">
				...
				<div class="last bottom txt_small" style="width:40%;">
					<div>(<?php echo $billDetails['name']; ?>)</div>
		...
		<div class="print_section">
			...
			<div class="bill_content">	
				...
				<div class="print_row">
					...
					<div class="txt_bold" style="width: 49%;">
						<div class="print_row">
							<div class="first print_row">
								<div>
									<div>Taxable Amount:</div>
