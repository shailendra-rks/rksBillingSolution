...
<?php endif; ?>
	...
	<hr>
	<form class="date_range" id="getBillsForm" method="post" action="viewBill.php">
	<div class="pagecell">
	...
	<table id="data_table" class="table table-striped order-column hover" style="width:100%">
        <thead>
            <tr>
                ...
                <th>Bill Number</th>
				<th>Date</th>
				<?php if($usrParam['usrType'] == "admin" || "control"): ?>
		...
		if($result && mysqli_num_rows($result) > 0){
			while($billData = mysqli_fetch_assoc($result))
			{
				...
				if($usrParam['usrType'] == "admin" || "control"){
				...
				echo "<td>".$billData['pdtnet']."</td>";
				echo "<td>".$billData['pdtgross']."</td>";
				if($usrPerm['biltyV'] == 1){
