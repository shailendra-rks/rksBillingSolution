	  ...
	  <form id="addCustForm" action="addCustomer.php" method="post">
		...
		<div class="modalrow">
			<div class="modalcell">
				...
				<input type="text" maxlength="10" placeholder="0123456789" name="pcontact" pattern="\b\d{10}\b" required>
			</div>
			<div class="modaldiv"></div>
			<div class="modalcell">
...
<?php elseif($mode == "edit" && $usrPerm['cstmrE'] == 1): ?>
	  ...
	  <form id="addCustForm" action="addCustomer.php" method="post">
		...
		<div class="modalrow">
			<div class="modalcell">
				<label for="pcontact"><b>Contact</b></label>
				<input type="text" maxlength="10" placeholder="0123456789" name="pcontact" value="<?php echo $custmorDetails['contactP']; ?>" pattern="\b\d{10}\b" required>
			</div>
			<div class="modaldiv"></div>
			<div class="modalcell">
				<label for="scontact"><b>Contact Other</b></label>
...
<?php elseif($mode == "edit" && $usrPerm['brandE'] == 1): ?>
	  ...
	  <form id="addBrandForm" action="addBrand.php" method="post">
		...
		<div class="modalrow_single">
			<label for="bname"><b>Name</b></label>
			<input type="text" name="bname" value="<?php echo $brandDetails['bName']; ?>" required>
			<label for="bIdentity"><b><?php echo $usrInfo['bIdentifier']; ?></b></label>
	  ...
	  <div class="modalrow">
		...
		<div class="modalrow">
			...
			<div class="modalcell">
				...
				<input type="text" maxlength="8" placeholder="01234567" name="hsn" pattern="\b\d{8}\b" required>
			</div>
		</div>
		<div class="modalrow">
			<div class="modalcell">
...
<?php elseif($mode == "edit" && $usrPerm['pdtE'] == 1): ?>
	  ...
	  <div class="modalrow">
		...
		<div class="modalrow">
			...
			<div class="modalcell">
				<label for="hsn"><b>HSN Number</b></label>
				<input type="text" maxlength="8" placeholder="01234567" name="hsn" value="<?php echo $productDetails['hsn']; ?>" pattern="\b\d{8}\b" required>
			</div>
		</div>
		<div class="modalrow">
			<div class="modalcell">
				<label for="rate"><b>Rate(₹)</b></label>
				<input type="text" name="rate" value="<?php echo $productDetails['rate']; ?>" required>
			</div>
			<div class="modaldiv"></div>
			<div class="modalcell">
				<label for="cgst"><b>CGST</b></label>
